...
/*    */ {
/* 23 */   public static final MaterialDoubleFunctionDeserializer INSTANCE = new MaterialDoubleFunctionDeserializer();
/*    */ 
/*    */ 
/*    */ 
/*    */   
...
/* 31 */     double defaultValue = jsonHelper.getDouble(json, "default");
/* 32 */     Object2DoubleRBTreeMap object2DoubleRBTreeMap = new Object2DoubleRBTreeMap();
/* 33 */     object2DoubleRBTreeMap.defaultReturnValue(defaultValue);
...
/* 37 */         double materialTypeValue = jsonHelper.getDouble(entry.getValue(), "element");
...
/* 66 */           object2DoubleRBTreeMap.put(MaterialHandler.getMaterial(entry.getKey()), jsonHelper.getDouble(entry.getValue(), "element"));
/*    */         }
/*    */       } 
/*    */     } 
...
/* 78 */         comment = "";
/*    */       } 
/* 80 */       CustomModule.instance.addCustomConfigDefiner((material, config) -> map.put(material, config.getDefinedDouble(path, map.getDouble(material), comment)));
/*    */     } 
/*    */ 
/*    */ 
/*    */     
/* 85 */     return material -> map.getDouble(material);
/*    */   }
/*    */ }


/* Location:              C:\Users\yxy24\Desktop\JAOPCA-1.12.2-2.3.13.34.jar!\thelm\jaopca\custom\json\MaterialDoubleFunctionDeserializer.class

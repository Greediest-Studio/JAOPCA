...
/* 67 */       Recipes.grinder.createRecipe().withInput(Collections.singleton(in)).withOutput(stack)
...
/* Location:              C:\Users\yxy24\Desktop\JAOPCA-1.12.2-2.3.13.34.jar!\thelm\jaopca\compat\techreborn\recipes\GrinderRecipeAction.class

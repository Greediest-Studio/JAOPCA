...
/*    */       }
/* 56 */       TinkerRegistry.registerBasinCasting((ICastingRecipe)new PreferenceCastingRecipe((String)this.output, match, ing, this.time.applyAsInt(ing), this.consumeCast, this.switchSlots));
/*    */     } else {
/*    */       
...
/*    */       }
/* 63 */       TinkerRegistry.registerBasinCasting((ICastingRecipe)new CastingRecipe(stack, match, ing, this.time.applyAsInt(ing), this.consumeCast, this.switchSlots));
/*    */     } 
/* 65 */     return true;
/*    */   }
/*    */ }
...
/* Location:              C:\Users\yxy24\Desktop\JAOPCA-1.12.2-2.3.13.34.jar!\thelm\jaopca\compat\tconstruct\recipes\BasinCastingRecipeAction.class
